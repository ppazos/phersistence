...
class A extends \CaboLabs\Phersistence\phersistent\Phersistent {
  ...
  function constraints()
  {
    return array(
      'a_field_1' => array(
        \CaboLabs\Phersistence\phersistent\PhConstraint::max(10)
      )
    );
  }
...
class D extends \CaboLabs\Phersistence\phersistent\Phersistent {

  public $d_field_1 = self::INT;
  public $d_field_2 = self::TEXT;
  public $hm_e = array(CaboLabs\Phersistence\phersistent\PhCollection::class, E::class);
}

class E extends \CaboLabs\Phersistence\phersistent\Phersistent {
...
class F extends \CaboLabs\Phersistence\phersistent\Phersistent {
...
/*
echo CaboLabs\Phersistence\phersistent\PhersistentMySQL::get_table_name($cins) .PHP_EOL;
echo CaboLabs\Phersistence\phersistent\PhersistentMySQL::get_table_name($A->create()) .PHP_EOL;
echo CaboLabs\Phersistence\phersistent\PhersistentMySQL::get_table_name($B->create()) .PHP_EOL;
*/
