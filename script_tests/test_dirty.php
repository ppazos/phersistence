...
class Employer extends \CaboLabs\Phersistence\phersistent\Phersistent {
  ...
  function constraints()
  {
    return array(
      'name' => array(
        \CaboLabs\Phersistence\phersistent\PhConstraint::maxLength(10)
      )
    );
  }
}

class PhoneNumber extends \CaboLabs\Phersistence\phersistent\Phersistent {
...
class Member extends \CaboLabs\Phersistence\phersistent\Phersistent {
  ...
  public $phones = array(CaboLabs\Phersistence\phersistent\PhCollection::class, PhoneNumber::class);
...
$man = new \CaboLabs\Phersistence\phersistent\PhersistentDefManager(NULL, $ph_db);
