...
// TEST COLLECTIONS
if (is_subclass_of(CaboLabs\Phersistence\phersistent\PhSet::class, CaboLabs\Phersistence\phersistent\PhCollection::class))
{
  echo CaboLabs\Phersistence\phersistent\PhSet::class .' is subclass of collection '. PHP_EOL;
}
else {
  echo CaboLabs\Phersistence\phersistent\PhSet::class .' is NOT subclass of collection '. PHP_EOL;
}

if (is_subclass_of(CaboLabs\Phersistence\phersistent\PhList::class, 'CaboLabs\Phersistence\phersistent\PhCollection'))
{
  echo CaboLabs\Phersistence\phersistent\PhList::class .' is subclass of collection '. PHP_EOL;
}
else {
  echo CaboLabs\Phersistence\phersistent\PhList::class .' is NOT subclass of collection '. PHP_EOL;
}
...
class A extends \CaboLabs\Phersistence\phersistent\Phersistent {
  ...
  public $bs = array(CaboLabs\Phersistence\phersistent\PhSet::class, B::class);
